              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
                <div className="bg-card p-6 rounded-lg shadow-elegant">
                  ...
                  <p className="text-muted-foreground">
                    Compreendemos a importância de portfolios visuais impactantes e otimização para pesquisas locais de serviços de arquitetura. Toda a gente merece a oportunidade de ter uma boa casa.
                  </p>
                </div>
                <div className="bg-card p-6 rounded-lg shadow-elegant">
